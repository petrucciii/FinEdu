...
1. Introduzione 3
   > \\\[1.1 Soluzione Proposta e Utenti Target 3](#soluzione-proposta-e-utenti-target)
   >
   > \\\[1.2 Differenze e Similitudini con altre Applicazioni 3](#differenze-e-similitudini-con-altre-applicazioni)
   >
   > \\\[1.3 Tecnologie Utilizzate 3](#tecnologie-utilizzate)
   >
   > \\\[1.4 Scelte Grafiche 4](#scelte-grafiche)
2. Database e Model 5
   > \\\[2.1 Model 5](#model)
   >
   > \\\[2.2 Descrizione Database 5](#descrizione-database)
   >
   > \\\[2.3 Diagramma ER Database\\\\\\\* 9](#diagramma-er-database)
   >
   > \\\[2.4 Schema Logico Database\\\\\\\* 9](#schema-logico-database)
3. Back-End 10
   > \\\[3.1 Descrizione 10](#descrizione)
   >
   > \\\[Autenticazione 10](#autenticazione)
   >
   > \\\[Gestione Utenti 10](#gestione-utenti)
   >
   > \\\[Esportazione in CSV 10](#esportazione-in-csv)
   >
   > \\\[Endpoint Prezzi 10](#endpoint-prezzi)
   >
   > \\\[Recupero dati dal bilancio 11](#recupero-dati-dal-bilancio)
   >
   > \\\[Inizio Educazione Finanziaria 11](#inizio-educazione-finanziaria)
   >
   > \\\[Visualizzazione Moduli 11](#visualizzazione-moduli)
   >
   > \\\[Lezioni 11](#lezioni)
   >
   > \\\[Gestione Educazione Finanziaria 11](#gestione-educazione-finanziaria)
   >
   > \\\[Portafogli e Ordini 12](#portafogli-e-ordini)
   >
   > \\\[Gestione Portafogli e Ordini 12](#gestione-portafogli-e-ordini)
   >
   > \\\[Grafico 12](#grafico)
   >
   > \\\[AJAX pop-up 12](#ajax-pop-up)
   >
   > \\\[3.2 Particolarità 12](#particolarità)
4. Front-End 13
   > \\\[4.1 Homepage 13](#homepage)
   >
   > \\\[\\\*\\\*4.2 Autenticazione 14\\\*\\\*](#autenticazione-1)
   >
   > \\\[Login Modal 14](#login-modal)
   >
   > \\\[Validazione Autenticazione 14](#validazione-autenticazione)
   >
   > \\\[Registrazione Modal 15](#registrazione-modal)
   >
   > \\\[Profilo Utente 15](#profilo-utente)
   >
   > \\\[Modal Eliminazione Utente 16](#modal-eliminazione-utente)
   >
   > \\\[Real-Time Password Reset Validazione 16](#real-time-password-reset-validazione)
   >
   > \\\[Warning Pop-Up 17](#warning-pop-up)
   >
   > \\\[\\\*\\\*4.3 Admin 18\\\*\\\*](#\\\_dn8dh7ok8c9)
   >
   > \\\[Navbar Amministrazione 18](#\\\_s3khu6flt7ch)
   >
   > \\\[Dashboard Administration 18](#\\\_9ln3zl48vchr)
   >
   > \\\[4.4 Gestione Utenti 19](#\\\_ee71g6sgq77l)
   >
   > \\\[Modal Azioni Utente 20](#modal-azioni-utente)
   >
   > \\\[4.5 Portafogli 21](#portafogli)
   >
   > \\\[Ordini 21](#ordini)
   >
   > \\\[Modal Aggiungi Portafogli 22](#modal-aggiungi-portafogli)
   >
   > \\\[Gestione Portafogli 22](#gestione-portafogli)
   >
   > \\\[Gestione Ordini 23](#gestione-ordini)
   >
   > \\\[4.6 Società 23](#società)
   >
   > \\\[Analisi di Mercato 23](#analisi-di-mercato)
   >
   > \\\[Notizia 24](#\\\_ycg5ybplz7rv)
   >
   > \\\[Negozia 24](#negozia)
   >
   > \\\[Gestione News 25](#gestione-news)
   >
   > \\\[Form Pubblicazione Notizia 26](#form-pubblicazione-notizia)
   >
   > \\\[Gestione Società 26](#gestione-società)
   >
   > \\\[Aggiungi Società 27](#aggiungi-società)
   >
   > \\\[Modifica e/o Visualizzazione 27](#modifica-eo-visualizzazione)
   >
   > \\\[1. Dati Base: 28](#dati-base)
   >
   > \\\[2. Quotazioni: 28](#quotazioni)
   >
   > \\\[3. Bilanci (Dati Finanziari): 29](#bilanci-dati-finanziari)
   >
   > \\\[4. Consiglio di Amministrazione: 29](#consiglio-di-amministrazione)
   >
   > \\\[Gestione Borse Valori 29](#gestione-borse-valori)
   >
   > \\\[4.7 Educazione Finanziaria 30](#educazione-finanziaria)
   >
   > \\\[Moduli e Progressi 30](#moduli-e-progressi)
   >
   > \\\[Modulo, Quiz 30](#modulo-quiz)
   >
   > \\\[Modulo, Spiegazione 31](#modulo-spiegazione)
   >
   > \\\[Gestione Moduli e Lezioni. 31](#gestione-moduli-e-lezioni.)
   >
   > \\\[Visualizza Spiegazione 32](#visualizza-spiegazione)
   >
   > \\\[Modifica Spiegazione 32](#modifica-spiegazione)
   >
   > \\\[Quiz Editor 32](#quiz-editor)
   >
   > \\\[Aggiungi e Modifica Quiz 33](#aggiungi-e-modifica-quiz)
   >
   > \\\[4.8 Tabelle Dizionario 33](#tabelle-dizionario)
   > \*Allegati in seguito data la difficoltà della visualizzazione, inoltre non è presente la chiave esterna, presente in quasi ogni entità, riferita all'utente che ha effettuato l'ultima modifica, vista la scarsa leggibilità che causerebbe.
5. Introduzione {#introduzione}
   1.1 Soluzione Proposta e Utenti Target {#soluzione-proposta-e-utenti-target}
   ...
   1.2 Differenze e Similitudini con altre Applicazioni {#differenze-e-similitudini-con-altre-applicazioni}
   Sono state identificate due principali applicazioni con simili caratteristiche:
   [[Bloomberg]{.underline}](https://www.bloomberg.com/): un'agenzia di stampa usata da professionisti che fornisce dati finanziari e di bilancio delle società quotate ([[MarketScreener]{.underline}](https://it.marketscreener.com/)è una versione gratuita e semplificata).
   [[Borsa Italiana]{.underline}](https://www.borsaitaliana.it/): l'applicazione della Borsa di Milano che contiene dati e notizie riguardanti il mondo finanziario italiano ed europeo, talvolta con accordi con enti ed istituzioni quali CONSOB e Bankitalia. Mette a disposizione informazioni di base su tutti gli strumenti quotati a Piazza Affari, ma anche una serie di corsi di formazione.
   [[Duolingo]{.underline}](https://it.duolingo.com/): una piattaforma di apprendimento linguistico che tramite un percorso guidato progressivo aiuta l'utente a raggiungere un obiettivo prefissato.
   ...
   1.3 Tecnologie Utilizzate {#tecnologie-utilizzate}
   ...
   Per quanto riguarda il Front End: le view sono scritte in HTML all'interno di file PHP per facilitare la gestione dei dati ricevuti dai controller; lo stile è stato sviluppato, principalmente usando classi [[Bootstrap]{.underline}](https://getbootstrap.com/) e [[FontAwesome]{.underline}](https://fontawesome.com/); per rendere le pagine più dinamiche sono state utilizzate chiamate asincrone (AJAX) che ricevono dal server JSON e lo elaborano costruendo pagine HTML; infine sono state usate le DataTables di [[jQuery]{.underline}](https://jquery.com/) per la creazione delle tabelle ed altre librerie come [[Chart.js]{.underline}](https://www.chartjs.org/) per l'elaborazione di dati.
   ...
   1.4 Scelte Grafiche {#scelte-grafiche}
...
6. Database e Model {#database-e-model}
   2.1 Model {#model}
   ...
   [Gestione dei Prezzi Storici: Si occupa di registrare i prezzi giornalieri (Prices) ottenuti dall'endpoint esterno (Yahoo Finance), associandoli correttamente al Listing (Ticker e MIC) per mantenere lo storico necessario alla costruzione dei grafici.]{.mark}
   [Gestione Logica dei Portafogli e Ordini: Gestisce le transazioni (Orders) e la conseguente manipolazione dei dati nei Portfolios, come:]{.mark}
   [Aggiornare la liquidità e il capitale investito di un portafoglio in base all'apertura o chiusura di un ordine.]{.mark}
   [Fornire i dati di base per il calcolo dinamico della variazione relativa percentuale e della plus/minusvalenza.]{.mark}
   [Gestione del Percorso Educativo Utente: Registra e recupera lo storico delle attività svolte dall'utente nella sezione Educazione Finanziaria, tramite la tabella Completed_Lessons, tracciando per ogni lezione i tentativi effettuati e lo stato di completamento.]{.mark}
   ...
   La tabella centrale della prima parte è "Companies", la quale rappresenta società da analizzare, ha una serie di attributi tra cui ISIN (International Securities Identification Number, regolato dalla norma [[ISO 6166]{.underline}](https://www.iso.org/standard/78502.html)) come identificativo, il sito web, il nome e il settore in cui opera, che è una tabella dizionario "Sector" (primary key definita da codici [[EA/IAF]{.underline}](https://services.accredia.it/accredia_tablesett.jsp?ID_LINK=1750&area=310)).
   ...
   2.3 Diagramma ER Database* {#diagramma-er-database}
   ![](media/image40.png){width="6.270833333333333in" height="4.627189413823272in"}
   2.4 Schema Logico Database* {#schema-logico-database}
   ![](media/image39.png){width="6.270833333333333in" height="3.541136264216973in"}
7. Back-End {#back-end}
   ...
   > Viene effettuato un controllo su tutte le lezioni dei moduli svolte (recuperate da "Completed\\\_Lessons") e viene stabilito cosa inviare alle view (se in corso, completato, bloccato).
   > Lezioni
   ...
   > 3.2 Particolarità {#particolarità}
   ...
   > Il sistema non elabora i bilanci aziendali poiché i formati disponibili nei portali ufficiali ([[ESEF]{.underline}](https://www.consob.it/web/area-pubblica/esef)) mancano di una standardizzazione che ne permetta l'estrazione automatica. È stato inoltre escluso l'utilizzo del formato standard XBRL, in quanto non è reperibile online gratuitamente. Si è invece optato per un formato XML redatto seguendo i [[principi contabili standard (IFRS) stabiliti da IASB.]{.underline}](https://www.ifrs.org/groups/international-accounting-standards-board/)
...
8. Front-End {#front-end}
   ...
   4.1 Homepage {#homepage}
   ![](media/image5.png){width="6.267716535433071in" height="2.8333333333333335in"}
   ...
   4.2 Autenticazione {#autenticazione-1}
   Login Modal
   ![](media/image18.png){width="5.286458880139983in" height="2.5128926071741033in"}
   ...
   Validazione Autenticazione![](media/image23.png){width="3.34375in" height="2.4114588801399823in"}
   ![](media/image9.png){width="3.3020833333333335in" height="2.463542213473316in"}
   Registrazione Modal
   ![](media/image26.png){width="6.432292213473316in" height="3.9583333333333335in"}
   ...
   Profilo Utente
   ![](media/image30.png){width="5.286458880139983in" height="3.5772320647419074in"}
   ...
   ![](media/image41.png){width="4.182292213473316in" height="2.6119291338582675in"}
   Real-Time Password Reset Validazione
   ![](media/image36.png){width="6.267716535433071in" height="2.6805555555555554in"}
   Un avviso a comparsa (pop-up) comunica l'esito dell'operazione, sia esso positivo o negativo.
   Warning Pop-Up![](media/image21.png){width="3.2708333333333335in" height="2.057036307961505in"}
   ![](media/image20.png){width="3.2864588801399823in" height="2.066048775153106in"}
   ...
   4.3 Admin
   Navbar Amministrazione![](media/image24.png){width="5.015625546806649in" height="2.7885378390201225in"}
   Dashboard Administration
   ![](media/image11.png){width="5.317491251093613in" height="2.7864588801399823in"}
   ...
   4.4 Gestione Utenti
   ![](media/image6.png){width="6.267716535433071in" height="3.2083333333333335in"}
   ...
   Modal Azioni Utente
   ![](media/image13.png){width="4.609375546806649in" height="5.488731408573928in"}
   ...
   4.5 Portafogli {#portafogli}
   ![](media/image14.png){width="6.267716535433071in" height="2.7777777777777777in"}
   ...
   Ordini
   ![](media/image19.png){width="6.267716535433071in" height="2.736111111111111in"}
   In questa pagina sono presentati campi di ogni ordine e la possibilità di chiuderlo.
   Modal Aggiungi Portafogli
   ![](media/image16.png){width="3.557292213473316in" height="2.1360181539807526in"}
   ...
   Gestione Portafogli
   ![](media/image35.png){width="6.267716535433071in" height="2.4583333333333335in"}
   ...
   Gestione Ordini
   ![](media/image37.png){width="6.267716535433071in" height="2.638888888888889in"}
   ...
   4.6 Società {#società}
   Analisi di Mercato
   ![](media/image31.png){width="6.267716535433071in" height="3.8055555555555554in"}
   ...
   Notizia![](media/image27.png){width="6.267716535433071in" height="2.5694444444444446in"}
   Negozia
   ![](media/image33.png){width="3.560534776902887in" height="3.0929899387576554in"}
   ...
   Gestione News
   ![](media/image17.png){width="6.24135498687664in" height="3.0156255468066493in"}
   ...
   ![](media/image3.png){width="4.119792213473316in" height="4.25423665791776in"}
   ...
   Gestione Società
   ![](media/image8.png){width="6.319538495188102in" height="2.9413024934383203in"}Anche la view per la gestione delle società è formata da una tabella con i dati principali, il numero di borse valori in cui è quotata, la possibilità di aggiungere, modificare, eliminare e filtrare la visualizzazione.
   Aggiungi Società
   ![](media/image12.png){width="3.9114588801399823in" height="4.013054461942257in"}
   ...
   Dati Base:
   > !\\\[](media/image28.png){width="5.932292213473316in" height="2.78125in"}In cui viene mostrato l\\\\'ISIN (senza possibilità di modifica), il nome, il sito web, il settore, il paese ed un eventuale logo.
   > Quotazioni:
   > !\\\[](media/image10.png){width="5.890625546806649in" height="2.625in"}
   >
   ...
   > Bilanci (Dati Finanziari):
   > !\\\[](media/image2.png){width="5.817708880139983in" height="2.4895833333333335in"}
   >
   ...
   > !\\\[](media/image15.png){width="5.880208880139983in" height="2.2395833333333335in"}
   >
   ...
   > ![](media/image22.png){width="6.267716535433071in" height="1.6527777777777777in"}
   ...
   > 4.7 Educazione Finanziaria {#educazione-finanziaria}
   > Moduli e Progressi![](media/image7.png){width="6.098958880139983in" height="3.079873140857393in"}
   ...
   > Modulo, Quiz
   > ![](media/image38.png){width="5.817708880139983in" height="3.7206277340332456in"}
   ...
   > Modulo, Spiegazione
   > ![](media/image25.png){width="5.692708880139983in" height="3.28087489063867in"}
   ...
   > ![](media/image34.png){width="6.267716535433071in" height="1.9861111111111112in"}
   ...
   > ![](media/image1.png){width="4.596760717410324in" height="2.2343755468066493in"}
   > Modifica Spiegazione
   > ![](media/image4.png){width="4.588542213473316in" height="2.9678641732283464in"}
   ...
   > Quiz Editor
   > ![](media/image32.png){width="6.267716535433071in" height="1.9722222222222223in"}
   ...
   > ![](media/image29.png){width="6.267716535433071in" height="2.6666666666666665in"}
   ...
   > 4.8 Tabelle Dizionario {#tabelle-dizionario}
